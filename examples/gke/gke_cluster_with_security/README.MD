# Example of GKE cluster connected to CAST AI with enabled Kvisor security agent
...
3. Create CAST AI related resources to connect GKE cluster to CAST AI with Kvisor enabled - `castai.tf`
