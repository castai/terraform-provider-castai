## EKS and CAST AI example for CAST AI Evictor Advanced Configuration CM
...
3. Create IAM and other CAST AI related resources to connect EKS cluster to CAST AI, configure Evictor Advanced Configuration CM - `castai.tf`
