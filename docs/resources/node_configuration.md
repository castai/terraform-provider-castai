...
- `loadbalancers` (Block List) Loadboalancer configuration for CAST provisioned nodes (see [below for nested schema](#nestedblock--aks--loadbalancers))
...
- `node_group_arn` (String) Cluster's node group ARN used for CAST provisioned node pools
