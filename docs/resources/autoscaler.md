...
- `autoscaler_policy_overrides` (Block List, Max: 1) autoscaler policy definitions to override current autoscaler settings (see [below for nested schema](#nestedblock--autoscaler_policy_overrides))
...
<a id="nestedblock--autoscaler_policy_overrides"></a>
### Nested Schema for `autoscaler_policy_overrides`

Optional:

- `cluster_limits` (Block List, Max: 1) defines minimum and maximum amount of CPU the cluster can have. (see [below for nested schema](#nestedblock--autoscaler_policy_overrides--cluster_limits))
...
- `node_downscaler` (Block List, Max: 1) node downscaler defines policies for removing nodes based on the configured conditions. (see [below for nested schema](#nestedblock--autoscaler_policy_overrides--node_downscaler))
...
- `spot_instances` (Block List, Max: 1) policy defining whether autoscaler can use spot instances for provisioning additional workloads. (see [below for nested schema](#nestedblock--autoscaler_policy_overrides--spot_instances))
- `unschedulable_pods` (Block List, Max: 1) policy defining autoscaler's behavior when unschedulable pods were detected. (see [below for nested schema](#nestedblock--autoscaler_policy_overrides--unschedulable_pods))

<a id="nestedblock--autoscaler_policy_overrides--cluster_limits"></a>
### Nested Schema for `autoscaler_policy_overrides.cluster_limits`

Optional:

- `cpu` (Block List, Max: 1) defines the minimum and maximum amount of CPUs for cluster's worker nodes. (see [below for nested schema](#nestedblock--autoscaler_policy_overrides--cluster_limits--cpu))
- `enabled` (Boolean) enable/disable cluster size limits policy.

<a id="nestedblock--autoscaler_policy_overrides--cluster_limits--cpu"></a>
### Nested Schema for `autoscaler_policy_overrides.cluster_limits.cpu`
...
<a id="nestedblock--autoscaler_policy_overrides--node_downscaler"></a>
### Nested Schema for `autoscaler_policy_overrides.node_downscaler`

Optional:

- `empty_nodes` (Block List, Max: 1) defines whether Node Downscaler should opt in for removing empty worker nodes when possible. (see [below for nested schema](#nestedblock--autoscaler_policy_overrides--node_downscaler--empty_nodes))
- `enabled` (Boolean) enable/disable node downscaler policy.
- `evictor` (Block List, Max: 1) defines the CAST AI Evictor component settings. Evictor watches the pods running in your cluster and looks for ways to compact them into fewer nodes, making nodes empty, which will be removed by the empty worker nodes policy. (see [below for nested schema](#nestedblock--autoscaler_policy_overrides--node_downscaler--evictor))

<a id="nestedblock--autoscaler_policy_overrides--node_downscaler--empty_nodes"></a>
### Nested Schema for `autoscaler_policy_overrides.node_downscaler.empty_nodes`
...
<a id="nestedblock--autoscaler_policy_overrides--node_downscaler--evictor"></a>
### Nested Schema for `autoscaler_policy_overrides.node_downscaler.evictor`
...
<a id="nestedblock--autoscaler_policy_overrides--spot_instances"></a>
### Nested Schema for `autoscaler_policy_overrides.spot_instances`
...
- `spot_backups` (Block List, Max: 1) policy defining whether autoscaler can use spot backups instead of spot instances when spot instances are not available. (see [below for nested schema](#nestedblock--autoscaler_policy_overrides--spot_instances--spot_backups))
...
- `spot_interruption_predictions` (Block List, Max: 1) configure the handling of SPOT interruption predictions. (see [below for nested schema](#nestedblock--autoscaler_policy_overrides--spot_instances--spot_interruption_predictions))

<a id="nestedblock--autoscaler_policy_overrides--spot_instances--spot_backups"></a>
### Nested Schema for `autoscaler_policy_overrides.spot_instances.spot_backups`
...
<a id="nestedblock--autoscaler_policy_overrides--spot_instances--spot_interruption_predictions"></a>
### Nested Schema for `autoscaler_policy_overrides.spot_instances.spot_interruption_predictions`
...
<a id="nestedblock--autoscaler_policy_overrides--unschedulable_pods"></a>
### Nested Schema for `autoscaler_policy_overrides.unschedulable_pods`
...
- `headroom` (Block List, Max: 1) additional headroom based on cluster's total available capacity for on-demand nodes. (see [below for nested schema](#nestedblock--autoscaler_policy_overrides--unschedulable_pods--headroom))
- `headroom_spot` (Block List, Max: 1) additional headroom based on cluster's total available capacity for spot nodes. (see [below for nested schema](#nestedblock--autoscaler_policy_overrides--unschedulable_pods--headroom_spot))
- `node_constraints` (Block List, Max: 1) defines the node constraints that will be applied when autoscaling with Unschedulable Pods policy. (see [below for nested schema](#nestedblock--autoscaler_policy_overrides--unschedulable_pods--node_constraints))

<a id="nestedblock--autoscaler_policy_overrides--unschedulable_pods--headroom"></a>
### Nested Schema for `autoscaler_policy_overrides.unschedulable_pods.headroom`
...
<a id="nestedblock--autoscaler_policy_overrides--unschedulable_pods--headroom_spot"></a>
### Nested Schema for `autoscaler_policy_overrides.unschedulable_pods.headroom_spot`
...
<a id="nestedblock--autoscaler_policy_overrides--unschedulable_pods--node_constraints"></a>
### Nested Schema for `autoscaler_policy_overrides.unschedulable_pods.node_constraints`
