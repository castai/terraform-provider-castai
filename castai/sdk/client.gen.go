...
type ClientInterface interface {
	...
	// UsersAPIListUserGroups request with any body
	UsersAPIListUserGroupsWithBody(ctx context.Context, organizationId string, userId string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	UsersAPIListUserGroups(ctx context.Context, organizationId string, userId string, body UsersAPIListUserGroupsJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
