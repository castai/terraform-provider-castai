...
//go:generate go run github.com/deepmap/oapi-codegen/cmd/oapi-codegen@v1.11.0 -o api.gen.go --old-config-style -generate types -include-tags $API_TAGS -package sdk $SWAGGER_LOCATION
//go:generate go run github.com/deepmap/oapi-codegen/cmd/oapi-codegen@v1.11.0 -o client.gen.go --old-config-style -templates codegen/templates -generate client -include-tags $API_TAGS -package sdk $SWAGGER_LOCATION
