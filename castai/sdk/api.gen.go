...
// CostreportV1beta1GetClusterCostHistoryResponse defines model for costreport.v1beta1.GetClusterCostHistoryResponse.
...
// CostreportV1beta1GetClusterCostHistoryResponseCostDetails defines model for costreport.v1beta1.GetClusterCostHistoryResponse.CostDetails.
...
// CostreportV1beta1GetClusterCostHistoryResponseCostEntry defines model for costreport.v1beta1.GetClusterCostHistoryResponse.CostEntry.
...
// CostreportV1beta1GetClusterCostReportResponseCostReportItem defines model for costreport.v1beta1.GetClusterCostReportResponse.CostReportItem.
...
// CostreportV1beta1GetClusterWorkloadReportResponse defines model for costreport.v1beta1.GetClusterWorkloadReportResponse.
...
// CostreportV1beta1GetClusterWorkloadReportResponseWorkloadCostItem defines model for costreport.v1beta1.GetClusterWorkloadReportResponse.WorkloadCostItem.
...
// CostreportV1beta1GetClusterWorkloadReportResponseWorkloadItem defines model for costreport.v1beta1.GetClusterWorkloadReportResponse.WorkloadItem.
...
// CostreportV1beta1GetSavingsRecommendationResponse_Recommendations defines model for CostreportV1beta1GetSavingsRecommendationResponse.Recommendations.
...
// CostreportV1beta1Saving defines model for costreport.v1beta1.Saving.
...
// CostreportV1beta1SavingsCurrentConfiguration defines model for costreport.v1beta1.SavingsCurrentConfiguration.
...
// CostreportV1beta1SavingsPrice defines model for costreport.v1beta1.SavingsPrice.
...
// CostreportV1beta1SavingsRecommendation defines model for costreport.v1beta1.SavingsRecommendation.
...
// InsightsV1ChecksCountHistoryItem defines model for insights.v1.ChecksCountHistoryItem.
type InsightsV1ChecksCountHistoryItem struct {
...
// InsightsV1GetCheckDetailsResponse defines model for insights.v1.GetCheckDetailsResponse.
type InsightsV1GetCheckDetailsResponse struct {
	...
	Objects *[]InsightsV1GetCheckDetailsResponseObjectItem `json:"objects,omitempty"`
...
// InsightsV1GetCheckDetailsResponseObjectItem defines model for insights.v1.GetCheckDetailsResponse.ObjectItem.
type InsightsV1GetCheckDetailsResponseObjectItem struct {
...
// InsightsV1GetChecksHistoryResponse defines model for insights.v1.GetChecksHistoryResponse.
type InsightsV1GetChecksHistoryResponse struct {
	Items *[]InsightsV1ChecksCountHistoryItem `json:"items,omitempty"`
}

// InsightsV1GetLatestReportResponse defines model for insights.v1.GetLatestReportResponse.
type InsightsV1GetLatestReportResponse struct {

	// Filtered checks.
	Checks  *[]InsightsV1GetLatestReportResponseCheckItem `json:"checks,omitempty"`
	Summary *InsightsV1GetLatestReportResponseSummary     `json:"summary,omitempty"`
}

// InsightsV1GetLatestReportResponseCheckItem defines model for insights.v1.GetLatestReportResponse.CheckItem.
type InsightsV1GetLatestReportResponseCheckItem struct {
...
// InsightsV1GetLatestReportResponseSummary defines model for insights.v1.GetLatestReportResponse.Summary.
type InsightsV1GetLatestReportResponseSummary struct {

	// Checks count by severity level.
	ChecksBySeverityLevel *InsightsV1GetLatestReportResponseSummary_ChecksBySeverityLevel `json:"checksBySeverityLevel,omitempty"`
	...
	// Number of resources that have no issues.
	ResourcesHealthy *int32 `json:"resourcesHealthy,omitempty"`

	// Number of resources scanned.
	ResourcesScanned *int32 `json:"resourcesScanned,omitempty"`

	// Number of resources that have issues.
	ResourcesWithIssues *int32 `json:"resourcesWithIssues,omitempty"`
}

// InsightsV1GetLatestReportResponseSummary_ChecksBySeverityLevel defines model for InsightsV1GetLatestReportResponseSummary.ChecksBySeverityLevel.
type InsightsV1GetLatestReportResponseSummary_ChecksBySeverityLevel struct {
	AdditionalProperties map[string]int32 `json:"-"`
}

// InsightsV1GetReportFiltersResponse defines model for insights.v1.GetReportFiltersResponse.
type InsightsV1GetReportFiltersResponse struct {
	Categories     *[]string `json:"categories,omitempty"`
	Namespaces     *[]string `json:"namespaces,omitempty"`
	SeverityLevels *[]string `json:"severityLevels,omitempty"`
}

// InsightsV1ScheduleScanResponse defines model for insights.v1.ScheduleScanResponse.
type InsightsV1ScheduleScanResponse map[string]interface{}
...
// InsightsAPIGetLatestReportParams defines parameters for InsightsAPIGetLatestReport.
type InsightsAPIGetLatestReportParams struct {
...
// InsightsAPIGetCheckDetailsParams defines parameters for InsightsAPIGetCheckDetails.
type InsightsAPIGetCheckDetailsParams struct {
...
// InsightsAPIGetReportFiltersParams defines parameters for InsightsAPIGetReportFilters.
type InsightsAPIGetReportFiltersParams struct {

	// (optional) return filters available for specific cluster.
	ClusterId *string `json:"clusterId,omitempty"`
}

// InsightsAPIGetChecksHistoryParams defines parameters for InsightsAPIGetChecksHistory.
type InsightsAPIGetChecksHistoryParams struct {
...
// Getter for additional properties for InsightsV1GetLatestReportResponseSummary_ChecksBySeverityLevel. Returns the specified
// element and whether it was found
func (a InsightsV1GetLatestReportResponseSummary_ChecksBySeverityLevel) Get(fieldName string) (value int32, found bool) {
	if a.AdditionalProperties != nil {
		value, found = a.AdditionalProperties[fieldName]
	}
	return
...
// Setter for additional properties for InsightsV1GetLatestReportResponseSummary_ChecksBySeverityLevel
func (a *InsightsV1GetLatestReportResponseSummary_ChecksBySeverityLevel) Set(fieldName string, value int32) {
	if a.AdditionalProperties == nil {
...
// Override default JSON handling for InsightsV1GetLatestReportResponseSummary_ChecksBySeverityLevel to handle AdditionalProperties
func (a *InsightsV1GetLatestReportResponseSummary_ChecksBySeverityLevel) UnmarshalJSON(b []byte) error {
	object := make(map[string]json.RawMessage)
	err := json.Unmarshal(b, &object)
	if err != nil {
		return err
...
// Override default JSON handling for InsightsV1GetLatestReportResponseSummary_ChecksBySeverityLevel to handle AdditionalProperties
func (a InsightsV1GetLatestReportResponseSummary_ChecksBySeverityLevel) MarshalJSON() ([]byte, error) {
	var err error
	object := make(map[string]json.RawMessage)
