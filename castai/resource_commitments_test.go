		...
		Steps: []resource.TestStep{
			{ // Import 2 commitments - one GCP CUD and one Azure reservations, both without configs
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("castai_commitments.test_azure", "azure_reservations.0.region", "eastus"),
			...
			{ // CUDs are unchanged, add config to the first Azure reservation and add another Azure reservation
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("castai_commitments.test_azure", "azure_reservations.1.region", "eastus"),
