...
// TestNodeTemplateSpotInterruptionPredictionsTypeJSONBody verifies that
// spot_interruption_predictions_type is sent as JSON null when the user
// has not configured it.
func TestNodeTemplateSpotInterruptionPredictionsTypeJSONBody(t *testing.T) {
	r := require.New(t)
	...
	r.Contains(string(body), `"spotInterruptionPredictionsType":null`,
		"spot_interruption_predictions_type should be sent as JSON null when not configured")
}
